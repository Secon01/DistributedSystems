...
public class Dummy extends Thread {                      
   ...
   private DateRange dates;                               // filter object instance
   private String roomName; 
   private String startDate;
   private String endDate;                                                       // room name for booking
   ...
   {  this.booking = new Booking();
      this.booking.setDate(startDate,endDate);
      this.booking.setRoomName(roomName);
   ...
   private void sendBookRoomRequest(PrintWriter out) {
      String jsonBody = serializeBooking(this.booking);
   ...
   public static void main(String[] args) throws IOException, InterruptedException {
      ...
      if(input .equals("search")) {  // Search()
         ...
         for(int i = 0; i < 1; i++) {
            ...
            new Dummy("Single Room","2024-04-10","2024-04-11").start();
            new Dummy("Single Room","2024-04-07","2024-04-09").start();
            new Dummy("Single Room","2024-04-12","2024-04-13").start();
