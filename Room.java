...
public class Room extends Request
{
    ...
    private ArrayList<DateRange> bookings;
    ...
    Room(int id, String name, int guests, double price, double stars,
        String area, int reviews, String image, boolean available,ArrayList<DateRange> bookings)
    {
        this.setManagerID(id);
        this.roomName = name;
        this.guests = guests;
    ...
    public synchronized void addBooking(DateRange booking) {
    ...
    public Room copy()
    {
        if(this.startDate == null || this.endDate == null) {
            ...
            this.stars, this.area, this.reviews, this.roomImage, this.available,this.bookings);
        } else {
            return new Room(this.getManagerID(), this.roomName, this.guests, this.price, 
            this.stars, this.area, this.reviews, this.roomImage, this.startDate, this.endDate, this.available, this.bookings);     // for rooms where dates are given
        }
    }
